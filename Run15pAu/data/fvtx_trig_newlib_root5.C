...
//void fvtx_trig_newlib_root5() // for running locally over one fiel to test before submitting to CONDOR
 {
   ...
   // const char *infile = "/gpfs/mnt/gpfs02/phenix/hhj/hhj1/klsmith/Jpsis/Run15pAu/fit_NOFVTX/krista_fits/matt_centrality_macros/CONDOR/pDST_105intersect108_mixed/total.root";
...
// if using CONDOR (opens text file)
 ...
 TH2D *mass_good_S = new TH2D("mass_good_S","mass_good_S", 300, 0, 15, 120, 0, 12); mass_good_S->Sumw2(); mass_good_S->SetLineWidth(2);
  ...
  TH2D *mass_rap_N_ul = new TH2D("mass_rap_N_ul","mass_rap_N_ul", 300, 0, 15, 93, -2.2, 2.45); mass_rap_N_ul->Sumw2(); mass_rap_N_ul->SetLineWidth(2);
  mass_rap_N_ul->GetXaxis()->SetTitle("mass (GeV/c^{2})");    mass_rap_N_ul->GetYaxis()->SetTitle("rapidity");
  
  TH2D *mass_rap_N_pp = new TH2D("mass_rap_N_pp","mass_rap_N_pp", 300, 0, 15, 93, -2.2, 2.45); mass_rap_N_pp->Sumw2(); mass_rap_N_pp->SetLineWidth(2);
  mass_rap_N_pp->GetXaxis()->SetTitle("mass (GeV/c^{2})");    mass_rap_N_pp->GetYaxis()->SetTitle("rapidity");
  
  TH2D *mass_rap_N_mm = new TH2D("mass_rap_N_mm","mass_rap_N_mm", 300, 0, 15, 93, -2.2, 2.45); mass_rap_N_mm->Sumw2(); mass_rap_N_mm->SetLineWidth(2);
  mass_rap_N_mm->GetXaxis()->SetTitle("mass (GeV/c^{2})");    mass_rap_N_mm->GetYaxis()->SetTitle("rapidity");
  
  TH2D *mass_rap_N_bg = new TH2D("mass_rap_N_bg","mass_rap_N_bg", 300, 0, 15, 93, -2.2, 2.45); mass_rap_N_bg->Sumw2(); mass_rap_N_bg->SetLineWidth(2);
  mass_rap_N_bg->GetXaxis()->SetTitle("mass (GeV/c^{2})");    mass_rap_N_bg->GetYaxis()->SetTitle("rapidity");
  
  TH2D *mass_rap_N_mix = new TH2D("mass_rap_N_mix","mass_rap_N_mix", 300, 0, 15, 93, -2.2, 2.45); mass_rap_N_mix->Sumw2(); mass_rap_N_mix->SetLineWidth(2);
  mass_rap_N_mix->GetXaxis()->SetTitle("mass (GeV/c^{2})");    mass_rap_N_mix->GetYaxis()->SetTitle("rapidity");
  
  //pretty stuff
  mass_rap_N_ul->SetMarkerColor(kBlue); mass_rap_N_ul->SetLineColor(kBlue);  mass_rap_N_ul->SetLineWidth(2);
  mass_rap_N_bg->SetMarkerColor(kRed);  mass_rap_N_bg->SetLineColor(kRed);  mass_rap_N_bg->SetLineWidth(2);
  mass_rap_N_mix->SetMarkerColor(kBlack);  mass_rap_N_mix->SetLineColor(kBlack);  mass_rap_N_mix->SetLineWidth(2);
  mass_rap_N_ul->GetXaxis()->SetRangeUser(2,5);  mass_rap_N_bg->GetXaxis()->SetRangeUser(2,5);  mass_rap_N_mix->GetXaxis()->SetRangeUser(2,5);
  
  ///Now S arm histos
  TH2D *mass_rap_S_ul = new TH2D("mass_rap_S_ul","mass_rap_S_ul", 300, 0, 15, 93, -2.2, 2.45); mass_rap_S_ul->Sumw2(); mass_rap_S_ul->SetLineWidth(2);
  mass_rap_S_ul->GetXaxis()->SetTitle("mass (GeV/c^{2})");    mass_rap_S_ul->GetYaxis()->SetTitle("rapidity");
  
  TH2D *mass_rap_S_pp = new TH2D("mass_rap_S_pp","mass_rap_S_pp", 300, 0, 15, 93, -2.2, 2.45); mass_rap_S_pp->Sumw2(); mass_rap_S_pp->SetLineWidth(2);
  mass_rap_S_pp->GetXaxis()->SetTitle("mass (GeV/c^{2})");    mass_rap_S_pp->GetYaxis()->SetTitle("rapidity");
  
  TH2D *mass_rap_S_mm = new TH2D("mass_rap_S_mm","mass_rap_S_mm", 300, 0, 15, 93, -2.2, 2.45); mass_rap_S_mm->Sumw2(); mass_rap_S_mm->SetLineWidth(2);
  mass_rap_S_mm->GetXaxis()->SetTitle("mass (GeV/c^{2})");    mass_rap_S_mm->GetYaxis()->SetTitle("rapidity");
  
  TH2D *mass_rap_S_bg = new TH2D("mass_rap_S_bg","mass_rap_S_bg", 300, 0, 15, 93, -2.2, 2.45); mass_rap_S_bg->Sumw2(); mass_rap_S_bg->SetLineWidth(2);
  mass_rap_S_bg->GetXaxis()->SetTitle("mass (GeV/c^{2})");    mass_rap_S_bg->GetYaxis()->SetTitle("rapidity");
  
  TH2D *mass_rap_S_mix = new TH2D("mass_rap_S_mix","mass_rap_S_mix", 300, 0, 15, 93, -2.2, 2.45); mass_rap_S_mix->Sumw2(); mass_rap_S_mix->SetLineWidth(2);
  mass_rap_S_mix->GetXaxis()->SetTitle("mass (GeV/c^{2})");    mass_rap_S_mix->GetYaxis()->SetTitle("rapidity");
  
  //pretty stuff
  mass_rap_S_ul->SetMarkerColor(kBlue); mass_rap_S_ul->SetLineColor(kBlue);  mass_rap_S_ul->SetLineWidth(2);
  mass_rap_S_bg->SetMarkerColor(kRed);  mass_rap_S_bg->SetLineColor(kRed);  mass_rap_S_bg->SetLineWidth(2);
  mass_rap_S_mix->SetMarkerColor(kBlack);  mass_rap_S_mix->SetLineColor(kBlack);  mass_rap_S_mix->SetLineWidth(2);
  mass_rap_S_ul->GetXaxis()->SetRangeUser(2,5);  mass_rap_S_bg->GetXaxis()->SetRangeUser(2,5);  mass_rap_S_mix->GetXaxis()->SetRangeUser(2,5);
...
string DG0_cut_N = "Tr0_DG0<(8.30848+100.812/(Tr0_px_fvtxmutr * Tr0_px_fvtxmutr + Tr0_py_fvtxmutr*Tr0_py_fvtxmutr + Tr0_pz_fvtxmutr*Tr0_pz_fvtxmutr)) && Tr1_DG0<(8.30848+100.812/(Tr1_px_fvtxmutr * Tr1_px_fvtxmutr + Tr1_py_fvtxmutr*Tr1_py_fvtxmutr + Tr1_pz_fvtxmutr*Tr1_pz_fvtxmutr))";
string DG0_cut_S = "Tr0_DG0<(10.6218+337.951/(Tr0_px_fvtxmutr * Tr0_px_fvtxmutr + Tr0_py_fvtxmutr*Tr0_py_fvtxmutr + Tr0_pz_fvtxmutr*Tr0_pz_fvtxmutr)) && Tr1_DG0<(10.6218+337.951/(Tr1_px_fvtxmutr * Tr1_px_fvtxmutr + Tr1_py_fvtxmutr*Tr1_py_fvtxmutr + Tr1_pz_fvtxmutr*Tr1_pz_fvtxmutr))";
string DDG0_cut_N = "Tr0_DDG0<(4.84265+127.384/(Tr0_px_fvtxmutr * Tr0_px_fvtxmutr + Tr0_py_fvtxmutr*Tr0_py_fvtxmutr + Tr0_pz_fvtxmutr*Tr0_pz_fvtxmutr)) && Tr1_DDG0<(4.84265+127.384/(Tr1_px_fvtxmutr * Tr1_px_fvtxmutr + Tr1_py_fvtxmutr*Tr1_py_fvtxmutr + Tr1_pz_fvtxmutr*Tr1_pz_fvtxmutr))";
string DDG0_cut_S = "Tr0_DDG0<(5.71576+111.407/(Tr0_px_fvtxmutr * Tr0_px_fvtxmutr + Tr0_py_fvtxmutr*Tr0_py_fvtxmutr + Tr0_pz_fvtxmutr*Tr0_pz_fvtxmutr)) && Tr1_DDG0<(5.71576+111.407/(Tr1_px_fvtxmutr * Tr1_px_fvtxmutr + Tr1_py_fvtxmutr*Tr1_py_fvtxmutr + Tr1_pz_fvtxmutr*Tr1_pz_fvtxmutr))";
  ...
  // used in PPG188    (removed for nofid files)
...
ifstream run_files2(filename[1].c_str() );
 ...
 //////////////////////////////////////////////////////////////////////////////////////
  ...
  string chi2_fvtx_cut = "Tr0_chi2_fvtx<30 && Tr0_chi2_fvtx>0 && Tr1_chi2_fvtx<30 && Tr1_chi2_fvtx>0";
  string chi2_fvtxmutr_cut = "Tr0_chi2_fvtxmutr<30 && Tr0_chi2_fvtxmutr>0 && Tr1_chi2_fvtxmutr<30 && Tr1_chi2_fvtxmutr>0";

 string dr_cut_N = "Tr0_dr_fvtx<(1.38061+28.89/(Tr0_px_fvtxmutr * Tr0_px_fvtxmutr + Tr0_py_fvtxmutr*Tr0_py_fvtxmutr + Tr0_pz_fvtxmutr*Tr0_pz_fvtxmutr)) && Tr1_dr_fvtx<(1.38061+28.89/(Tr1_px_fvtxmutr * Tr1_px_fvtxmutr + Tr1_py_fvtxmutr*Tr1_py_fvtxmutr + Tr1_pz_fvtxmutr*Tr1_pz_fvtxmutr))";
string dr_cut_S = "Tr0_dr_fvtx<(1.67962+26.8308/(Tr0_px_fvtxmutr * Tr0_px_fvtxmutr + Tr0_py_fvtxmutr*Tr0_py_fvtxmutr + Tr0_pz_fvtxmutr*Tr0_pz_fvtxmutr)) && Tr1_dr_fvtx<(1.67962+26.8308/(Tr1_px_fvtxmutr * Tr1_px_fvtxmutr + Tr1_py_fvtxmutr*Tr1_py_fvtxmutr + Tr1_pz_fvtxmutr*Tr1_pz_fvtxmutr))";
string dtheta_cut_N = "Tr0_dtheta_fvtx<(0.0473169+0.665664/(Tr0_px_fvtxmutr * Tr0_px_fvtxmutr + Tr0_py_fvtxmutr*Tr0_py_fvtxmutr + Tr0_pz_fvtxmutr*Tr0_pz_fvtxmutr)) && Tr1_dtheta_fvtx<(0.0473169+0.665664/(Tr1_px_fvtxmutr * Tr1_px_fvtxmutr + Tr1_py_fvtxmutr*Tr1_py_fvtxmutr + Tr1_pz_fvtxmutr*Tr1_pz_fvtxmutr))";
string dtheta_cut_S = "Tr0_dtheta_fvtx<(0.062556+0.580508/(Tr0_px_fvtxmutr * Tr0_px_fvtxmutr + Tr0_py_fvtxmutr*Tr0_py_fvtxmutr + Tr0_pz_fvtxmutr*Tr0_pz_fvtxmutr)) && Tr1_dtheta_fvtx<(0.062556+0.580508/(Tr1_px_fvtxmutr * Tr1_px_fvtxmutr + Tr1_py_fvtxmutr*Tr1_py_fvtxmutr + Tr1_pz_fvtxmutr*Tr1_pz_fvtxmutr))";
string dphi_cut_N = "Tr0_dphi_fvtx<(0.121509+1.55712/(Tr0_px_fvtxmutr * Tr0_px_fvtxmutr + Tr0_py_fvtxmutr*Tr0_py_fvtxmutr + Tr0_pz_fvtxmutr*Tr0_pz_fvtxmutr)) && Tr1_dphi_fvtx<(0.121509+1.55712/(Tr1_px_fvtxmutr * Tr1_px_fvtxmutr + Tr1_py_fvtxmutr*Tr1_py_fvtxmutr + Tr1_pz_fvtxmutr*Tr1_pz_fvtxmutr))";
string dphi_cut_S = "Tr0_dphi_fvtx<(0.121325+1.79439/(Tr0_px_fvtxmutr * Tr0_px_fvtxmutr + Tr0_py_fvtxmutr*Tr0_py_fvtxmutr + Tr0_pz_fvtxmutr*Tr0_pz_fvtxmutr)) && Tr1_dphi_fvtx<(0.121325+1.79439/(Tr1_px_fvtxmutr * Tr1_px_fvtxmutr + Tr1_py_fvtxmutr*Tr1_py_fvtxmutr + Tr1_pz_fvtxmutr*Tr1_pz_fvtxmutr))";
  ...
  /// run each seperatley then add three files togetehr
  // string vtx_trigger = "lvl1_trigscaled&0x00000010";  // narrow trigger
  //string vtx_trigger = "lvl1_trigscaled&0x00000001";
  // string vtx_trigger = "lvl1_trigscaled&0x00000002";

 string evt_cut = "(Evt_bbcZ<30) && (Evt_bbcZ > -30)";  // already applied in dimuon container make_dimu.C
 
 
 // string evt_cut = "(Evt_fvtxZ<40) && (Evt_fvtxZ > -40)";  // already applied in dimuon container make_dimu.C
  ////string evt_cut = "(Evt_bbcZ>-10) && (Evt_bbcZ < 10)";  // already applied in dimuon container make_dimu.C

 string cuts_N = "&&" + evt_cut + "&&" + rap_cut_N  + "&&" + pz_fvtxmutr_cut_N + "&&"+ muon_arm_cut_N  + "&&" + dr_cut_N + "&&" + dtheta_cut_N + "&&" + dphi_cut_N + "&&" + fvtx_trk_vtx ;
 string cuts_S = "&&" + evt_cut + "&&" + rap_cut_S  + "&&" + pz_fvtxmutr_cut_S + "&&" + muon_arm_cut_S + "&&" + dr_cut_S + "&&" + dtheta_cut_S + "&&" + dphi_cut_S + "&&" + fvtx_trk_vtx;
 
 // string cuts_N = "&&" + evt_cut + "&&" + rap_cut_N  + "&&" + pz_fvtxmutr_cut_N + "&&"+ muon_arm_cut_N  + "&&" + sng_fvtx_cut + "&&" + dr_cut_N + "&&" + dtheta_cut_N + "&&" + dphi_cut_N + "&&" + fvtx_trk_vtx ;
 //string cuts_S = "&&" + evt_cut + "&&" + rap_cut_S  + "&&" + pz_fvtxmutr_cut_S + "&&" + muon_arm_cut_S + "&&" + sng_fvtx_cut + " &&" + dr_cut_S + "&&" + dtheta_cut_S + "&&" + dphi_cut_S + "&&" + fvtx_trk_vtx; 
 ////////////////////////////
...
/////////////////////////////////////
 ...
 /////////////////////////////////////
  ...
  /// 40-84
  T->Project("mass_fvtx_pt_4084_N_ul","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("lvl1_trigscaled&0x00100000&&charge==0&&same_event==1&&centrality>40&&centrality<=84" + cuts_N).c_str() );
  
  T->Project("mass_fvtx_pt_4084_N_pp","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("lvl1_trigscaled&0x00100000&&charge>0&&same_event==1&&centrality>40&&centrality<=84" + cuts_N).c_str() ); 
   
  T->Project("mass_fvtx_pt_4084_N_mm","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("lvl1_trigscaled&0x00100000&&charge<0&&same_event==1&&centrality>40&&centrality<=84" + cuts_N).c_str() );
 
  T->Project("mass_fvtx_pt_4084_N_mix","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("charge==0&&same_event==0&&centrality>40&&centrality<=84" + cuts_N).c_str() );

  ///project 20 - 84
  T->Project("mass_fvtx_pt_2084_N_ul","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("lvl1_trigscaled&0x00100000&&charge==0&&same_event==1&&centrality>20&&centrality<=84" + cuts_N).c_str() );
  
  T->Project("mass_fvtx_pt_2084_N_pp","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("lvl1_trigscaled&0x00100000&&charge>0&&same_event==1&&centrality>20&&centrality<=84" + cuts_N).c_str() ); 
   
  T->Project("mass_fvtx_pt_2084_N_mm","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("lvl1_trigscaled&0x00100000&&charge<0&&same_event==1&&centrality>20&&centrality<=84" + cuts_N).c_str() );
 
  T->Project("mass_fvtx_pt_2084_N_mix","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("charge==0&&same_event==0&&centrality>20&&centrality<=84" + cuts_N).c_str() );

  // North arm rap

  T->Project("mass_rap_N_ul","rapidity:mass_fvtxmutr", ("lvl1_trigscaled&0x00100000&&charge==0&&same_event==1" + cuts_N).c_str() );
  cout<<"North arm unlike sign: "<<mass_rap_N_ul->Integral()<<endl;
  
  T->Project("mass_rap_N_pp","rapidity:mass_fvtxmutr", ("lvl1_trigscaled&0x00100000&&charge>0&&same_event==1" + cuts_N).c_str() ); 
  cout<<"North arm ++: "<<mass_rap_N_pp->Integral()<<endl;
    
  T->Project("mass_rap_N_mm","rapidity:mass_fvtxmutr", ("lvl1_trigscaled&0x00100000&&charge<0&&same_event==1" + cuts_N).c_str() );
  cout<<"North arm --: "<<mass_rap_N_mm->Integral()<<endl;
 
  T->Project("mass_rap_N_mix","rapidity:mass_fvtxmutr", ("charge==0&&same_event==0" + cuts_N).c_str() );
  cout<<"North arm mixed: "<<mass_rap_N_mix->Integral()<<endl;
  ...
  /// 40-84
  T->Project("mass_fvtx_pt_4084_S_ul","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("lvl1_trigscaled&0x00200000&&charge==0&&same_event==1&&centrality>40&&centrality<=84" + cuts_S).c_str() );
  
  T->Project("mass_fvtx_pt_4084_S_pp","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("lvl1_trigscaled&0x00200000&&charge>0&&same_event==1&&centrality>40&&centrality<=84" + cuts_S).c_str() ); 
   
  T->Project("mass_fvtx_pt_4084_S_mm","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("lvl1_trigscaled&0x00200000&&charge<0&&same_event==1&&centrality>40&&centrality<=84" + cuts_S).c_str() );
 
  T->Project("mass_fvtx_pt_4084_S_mix","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("charge==0&&same_event==0&&centrality>40&&centrality<=84" + cuts_S).c_str() );

  ///project 20 - 84
  T->Project("mass_fvtx_pt_2084_S_ul","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("lvl1_trigscaled&0x00200000&&charge==0&&same_event==1&&centrality>20&&centrality<=84" + cuts_S).c_str() );
  
  T->Project("mass_fvtx_pt_2084_S_pp","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("lvl1_trigscaled&0x00200000&&charge>0&&same_event==1&&centrality>20&&centrality<=84" + cuts_S).c_str() ); 
   
  T->Project("mass_fvtx_pt_2084_S_mm","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("lvl1_trigscaled&0x00200000&&charge<0&&same_event==1&&centrality>20&&centrality<=84" + cuts_S).c_str() );
 
  T->Project("mass_fvtx_pt_2084_S_mix","sqrt(  ((Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)*(Tr0_px_fvtxmutr + Tr1_px_fvtxmutr)) +  ((Tr0_py_fvtxmutr + Tr1_py_fvtxmutr)*(Tr0_py_fvtxmutr + Tr1_py_fvtxmutr))  ):mass_fvtxmutr", ("charge==0&&same_event==0&&centrality>20&&centrality<=84" + cuts_S).c_str() );


   ///S arm rap
  T->Project("mass_rap_S_ul","rapidity:mass_fvtxmutr", ("lvl1_trigscaled&0x00200000&&charge==0&&same_event==1" + cuts_S).c_str() );
  cout<<"South arm unlike sign: "<<mass_rap_S_ul->Integral()<<endl;
 
  T->Project("mass_rap_S_pp","rapidity:mass_fvtxmutr", ("lvl1_trigscaled&0x00200000&&charge>0&&same_event==1" + cuts_S).c_str() ); 
  cout<<"South arm ++: "<<mass_rap_S_pp->Integral()<<endl;
  
  T->Project("mass_rap_S_mm","rapidity:mass_fvtxmutr", ("lvl1_trigscaled&0x00200000&&charge<0&&same_event==1" + cuts_S).c_str() );
  cout<<"South arm --: "<<mass_rap_S_mm->Integral()<<endl;
 
  T->Project("mass_rap_S_mix","rapidity:mass_fvtxmutr", ("charge==0&&same_event==0" + cuts_S).c_str() );
  cout<<"South arm mixed: "<<mass_rap_S_mix->Integral()<<endl;
 ...
 T->Project("runs","runnumber","abs(Evt_bbcZ)<30");
  ...
  string ul_N_data = evt_cut + "&&" + nidhits_cut2 + "&&" + lastgap_cut2 + "&&" + DG0_cut2 + "&&" + DDG0_cut2 + "&&" + tkchi2_cut2 + "&&" + octant_cut2 + "&&" + mass_cut2 + "&&" + pz_fvtxmutr_cut2_N + "&&" + ul_cut2;  
  string ul_S_data = evt_cut + "&&" + nidhits_cut2 + "&&" + lastgap_cut2 + "&&" + DG0_cut2 + "&&" + DDG0_cut2 + "&&" + tkchi2_cut2 + "&&" + octant_cut2 + "&&" + mass_cut2 + "&&" + pz_fvtxmutr_cut2_S + "&&" + ul_cut2;  
  //lets start with dr
 ...
 //char const *outfile = "test.root";  
  ...
  mass_rap_N_mm->Write();
  mass_rap_N_bg->Write();
  mass_rap_N_mix->Write();

  mass_rap_S_ul->Write();
  mass_rap_S_pp->Write();
  mass_rap_S_mm->Write();
  mass_rap_S_bg->Write();
  mass_rap_S_mix->Write();
