...
Double_t CBcalc_jpsi(Double_t *xx, Double_t *par)  // CB fucntion for J/psi 
{
  ...
  if(north_arm)
    ratio = 392.414/4593.28;
  else
    ratio = 196.10/2393.36;

  if(north_arm)
    fraction = 0.215/0.10598;
  else
    fraction = 0.288/0.12649;
	...
	{     
	  if(special == 0)
	      ...
	      else 
		{
		  ...
		  //////////////////////////////////////////////////////////////////////////////////////////////////////////////	
		   file1S = TFile::Open("psi2S_root_files/Run15pAu_sng_psi2S_final_N.root");  // final result file
		   //////////////////////////////////////////////////////////////////////////////////////////////////////////////	
      ...
      else
	{
	  if(special == 0)
	      ...
	      else      
		{
		  ...
		  //////////////////////////////////////////////////////////////////////////////////////////////////////////////	
		   file1S = TFile::Open("psi2S_root_files/Run15pAu_sng_psi2S_final_S.root");  // final result file
		   //////////////////////////////////////////////////////////////////////////////////////////////////////////////	
   ...
   if(north_arm) 
     {
       ...
       total_fit->SetParLimits(0, 0.75, 2);
 ...
 if(fixed_width && fixed_mass)
    {
      if(north_arm)
	{
	  total_fit->FixParameter(2, 3.16236);
	  total_fit->FixParameter(3, 0.118067);
	}
      else
	{
	  // badprobcut
	  	  total_fit->FixParameter(2, 3.12973); 
	  	  total_fit->FixParameter(3, 0.13112);

	  // // no badprob cut
	  // total_fit->FixParameter(2, 3.13042); 
	  // total_fit->FixParameter(3, 0.125369);  
