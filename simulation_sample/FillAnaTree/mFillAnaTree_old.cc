...
{  
	...
	*/
	...
	hmass_fvtx = new TH3F("hmass_fvtx","",300,0,15,48,0,12,88,-2.2,2.2);
	hmass_fvtx_pp = new TH3F("hmass_fvtx_pp","",300,0,15,48,0,12,88,-2.2,2.2);
	hmass_fvtx_mm = new TH3F("hmass_fvtx_mm","",300,0,15,48,0,12,88,-2.2,2.2);

	hmass_mismatch = new TH3F("hmass_mismatch","",300,0,15,48,0,12,88,-2.2,2.2);
	hmass_eta_acc = new TH3F("hmass_eta_acc","",300,0,15,48,0,12,88,-2.2,2.2);

	//	hmass_mismatch_pp = new TH3F("hmass_mismatch_pp","",300,0,15,48,0,12,88,-2.2,2.2);
	//	hmass_mismatch_mm = new TH3F("hmass_mismatch_mm","",300,0,15,48,0,12,88,-2.2,2.2);
	...
	if(dimucon)
	  {
		...
		int run_num = trigrun->get_run_number();
			...
			// these cuts are for pro108 fvtx+fvtx case - June 21, 2020
			dr_cut_N = Tr0_dr_fvtx<(1.3633+32.6696/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && Tr1_dr_fvtx<(1.3633+32.6696/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			dr_cut_S = Tr0_dr_fvtx<(1.54595+27.4503/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && Tr1_dr_fvtx<(1.54595+27.4503/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			dtheta_cut_N = Tr0_dtheta_fvtx<(0.0463543+0.588233/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && Tr1_dtheta_fvtx<(0.0463543+0.588233/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			dtheta_cut_S = Tr0_dtheta_fvtx<(0.0574534+0.542072/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && Tr1_dtheta_fvtx<(0.0574534+0.542072/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			dphi_cut_N = Tr0_dphi_fvtx<(0.113844+2.14198/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && Tr1_dphi_fvtx<(0.113844+2.14198/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			dphi_cut_S = Tr0_dphi_fvtx<(0.112266+1.63119/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && Tr1_dphi_fvtx<(0.112266+1.63119/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			DG0_N = DG0_Tr0<(8.28893+111.751/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && DG0_Tr1<(8.28893+111.751/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			DG0_S = DG0_Tr0<(9.10074+376.001/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && DG0_Tr1<(9.10074+376.001/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			DDG0_N = DDG0_Tr0<(4.31349+154.452/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && DDG0_Tr1<(4.31349+154.452/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			DDG0_S = DDG0_Tr0<(4.70991+126.4/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && DDG0_Tr1<(4.70991+126.4/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			...
			// PPG188 fid cut S
			// fiducial_S = cent_evt != -12;
	
			// ppg188 cuts
			// dr_cut_N = Tr0_dr_fvtx<(1.72516+24.9488/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && Tr1_dr_fvtx<(1.72516+24.9488/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			// dr_cut_S = Tr0_dr_fvtx<(1.50271+27.7994/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && Tr1_dr_fvtx<(1.50271+27.7994/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			// dtheta_cut_N = Tr0_dtheta_fvtx<(0.0514247+0.618608/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && Tr1_dtheta_fvtx<(0.0514247+0.618608/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			// dtheta_cut_S = Tr0_dtheta_fvtx<(0.0554013+0.563137/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && Tr1_dtheta_fvtx<(0.0554013+0.563137/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			// dphi_cut_N = Tr0_dphi_fvtx<(0.122587+1.53902/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && Tr1_dphi_fvtx<(0.122587+1.53902/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			// dphi_cut_S = Tr0_dphi_fvtx<(0.112116+1.6148/(px_Tr0 * px_Tr0 + py_Tr0*py_Tr0 + pz_Tr0*pz_Tr0)) && Tr1_dphi_fvtx<(0.112116+1.6148/(px_Tr1 * px_Tr1 + py_Tr1*py_Tr1 + pz_Tr1*pz_Tr1));
			...
			for (int is=0; is<nsng; is++)
			  {
			    ...
			    float sngmu1_px = sngmu1->get_px();
			    float sngmu1_py = sngmu1->get_py();
			    float sngmu1_pz = sngmu1->get_pz();
		    
			    float sngmu1_pT	= sqrt(sngmu1_px*sngmu1_px + sngmu1_py*sngmu1_py);
			    float sngmu1_p = sqrt(sngmu1_pT*sngmu1_pT + sngmu1_pz*sngmu1_pz);
			    float sngmu1_eta = 0.5*log((sngmu1_p+sngmu1_pz)/(sngmu1_p-sngmu1_pz));
			    float sngmu1_chi2 = sngmu1->get_chi2();
			    float sngmu1_lastgap = sngmu1->get_lastgap();
				...
				float sngmu2_px = sngmu2->get_px();
				float sngmu2_py = sngmu2->get_py();
				float sngmu2_pz = sngmu2->get_pz();
						
				float sngmu2_pT = sqrt(sngmu2_px*sngmu2_px + sngmu2_py*sngmu2_py);
				float sngmu2_p = sqrt(sngmu2_pT*sngmu2_pT + sngmu2_pz*sngmu2_pz);
				float sngmu2_eta = 0.5*log((sngmu2_p+sngmu2_pz)/(sngmu2_p-sngmu2_pz));
				...
				float nhits_fvtx2 = fvtxmc_sngmu2->get_mc_hits_fvtx();
				float nhits_svx2 = fvtxmc_sngmu2->get_mc_hits_svx();
				float nhits_g_fvtx2 = fvtxmc_sngmu2->get_mc_hits_fvtx_true();
				float nhits_g_svx2 = fvtxmc_sngmu2->get_mc_hits_svx_true();

				float mismatch_num2 = nhits_g_fvtx2 + nhits_g_svx2;
				float mismatch_denom2 = nhits_fvtx2 + nhits_svx2;
				float mismatch_ratio2 = mismatch_num2 / mismatch_denom2;
				...
				if( (px_Tr0 == sngmu1_px) &&  (py_Tr0 == sngmu1_py)  &&  (pz_Tr0 == sngmu1_pz) )  
				  {
				    if( abs(mc_pid1) == 13)	
				      {
					if( (px_Tr1 == sngmu2_px) &&  (py_Tr1 == sngmu2_py)  &&  (pz_Tr1 == sngmu2_pz) )  
					  {
					    if( abs(mc_pid2) == 13)	
					      {
						if( (nhits_fvtx_Tr0 > 0) && (nhits_fvtx_Tr1 > 0) ) // select fvtx tracks in sanghoon's new pdst
						  {
											...
											if(octant > 0)
											  {
													...
													if(DG0_N && DDG0_N && ( abs(pz_Tr0) > 2) && (abs(pz_Tr1) > 2) && (pz_Tr0 > 0) && (pz_Tr1 > 0) && fiducial_N) 
													  {
														...
														hmass_fvtx_pp->Fill(mass_fvtxmutr,dimu_pT,hits_rap); 

													      }
													    if(Charge < 0)
													      {
														hdimu_mm_pT_y_zvtx_w_pp->Fill(dimu_pT, hits_rap, simZ, weight_pT_pp*weight_y_pp*weight_z);   
														hmass_fvtx_mm->Fill(mass_fvtxmutr,dimu_pT,hits_rap);
												...
												if( hits_rap <=-1.2 && hits_rap >=-2.2 && Tr0_rap <=-1.2 && Tr0_rap >=-2.2  && Tr1_rap <=-1.2 && Tr1_rap >=-2.2)  // South
												  {
												    if(DG0_S && DDG0_S && ( abs(pz_Tr0) > 2) && (abs(pz_Tr1) > 2) && (pz_Tr0 < 0) && (pz_Tr1 < 0)) // && fiducial_S)  there is no fid cut S in PPG188
												      {
				...
				if( hits_rap >=1.2 && hits_rap <=2.2 && sngmu1_eta >=1.2 && sngmu1_eta <=2.2 && sngmu2_eta >=1.2 && sngmu2_eta <=2.2 )  
				  { 
				    if(same_evt == 1)
				      {
					if( ( abs(pz_Tr0) > 2) && (abs(pz_Tr1) > 2) && (pz_Tr0 > 0) && (pz_Tr1 > 0))
					  hmass_eta_acc->Fill(mass_fvtxmutr,dimu_pT,hits_rap); 
				      }
				  }
				if( hits_rap <=-1.2 && hits_rap >=-2.2 && sngmu1_eta <=-1.2 && sngmu1_eta >=-2.2  && sngmu2_eta <=-1.2 && sngmu2_eta >=-2.2) 
				  {
