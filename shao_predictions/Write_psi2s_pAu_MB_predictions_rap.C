...
void Write_psi2s_pAu_MB_predictions_rap()
{
 ...
 //  for(int arm = 0; arm < 2; arm++)
      ...
      for(int i = 0; i < 6; i++)
	{
	  //	  if(arm == 0)
	    {
	     if(i == 0)
		sprintf(name100,"tables_RpAu/psi2S_yCMS_PHENIX_EPPS16.68CL.MUFu.Rwgt.MB.dat"); // u_ncteq15_68_S;
	      if(i == 1)
		sprintf(name100,"tables_RpAu/psi2S_yCMS_PHENIX_EPPS16.68CL.MUFd.Rwgt.MB.dat"); // 
	      if(i == 2)
		sprintf(name100,"tables_RpAu/psi2S_yCMS_PHENIX_EPPS16.68CL.MUFc.Rwgt.MB.dat"); // u_epps_68_S;
	      if(i == 3)
		sprintf(name100,"tables_RpAu/psi2S_yCMS_PHENIX_nCTEQ15.68CL.MUFu.Rwgt.MB.dat"); // u_epps_68_S;
	      if(i == 4)
		sprintf(name100,"tables_RpAu/psi2S_yCMS_PHENIX_nCTEQ15.68CL.MUFd.Rwgt.MB.dat"); // d_epps_68_S;
	      if(i == 5)
		sprintf(name100,"tables_RpAu/psi2S_yCMS_PHENIX_nCTEQ15.68CL.MUFc.Rwgt.MB.dat"); // c_epps_68_S;
	    }
	  // if(arm == 1)
	  //   {
	  //     if(i == 0)
...
double rap_epps_down[2][3] = {
  ...
  //double rap_array_pAu[6] =  {-1.95, -1.7, -1.45, 1.45, 1.7, 1.95};
  // double rap_array_pAu[6] =  {-1.85, -1.7, -1.55, 1.55, 1.7, 1.85};
  ...
  TFile *h = new TFile("psi2s_RpAu_MB_predictions_rap.root", "RECREATE");
  h->cd();
