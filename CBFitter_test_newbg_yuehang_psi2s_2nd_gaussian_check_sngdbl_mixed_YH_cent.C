...
Double_t CBcalc_jpsi(Double_t *xx, Double_t *par)  // CB fucntion for J/psi 
{
 ...
 // pT integrated - final result with prob05 + prob00 sims
  if(north_arm)
   ratio = 826.132/11297.8;
   else
     ratio = 1318/11299.7;
  
  if(north_arm)
    fraction = 0.215/0.09144;
  else
    fraction = 0.215/0.09925;
...
double parA = 0;
 ...
 // // sys study on fixed jpsi mass
 // if(north_arm)
 //    {
 //      parA = 1.02539;
 //      parB = 10;
 //      parC = 3.16603 - 2*0.00161975;
 //      parD = 0.102923;
 //    }
 //  else
 //    {
	...
	{     
	  if(special == 0)
	      ...
	      else 
		{
		  ...
		  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		    file1S = TFile::Open("psi2S_root_files/Run15pp_sngdbl_psi2S_final_N.root");   // result file
		   /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      else
	{
	  if(special == 0)
	      ...
	      else      
		{
		  ...
		  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		  file1S = TFile::Open("psi2S_root_files/Run15pp_sngdbl_psi2S_final_S.root");  // result file
		  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 //  recomassBG3->Scale(mixnorm);
  ...
  // for sys study
 // /////////////////////////////////////////////////////////////////////////////////////////
  //double Nmix = recomassBG3->IntegralAndError(recomassBG3->GetXaxis()->FindBin(1.5), recomassBG3->GetXaxis()->FindBin(4.5),dNmix,"");
  // double mixnorm = 2*sqrt(Npp*Nmm)/Nmix;
  //recomassBG->Scale(bgnorm);
  //recomassBG3->Scale(mixnorm);
   /////////////////////////////////////////////////////////////////////////////////////////
 ...
 if(fixed_lineshape)
     {
       if(north_arm)
	 {
	   total_fit->FixParameter(0, parA);
	   total_fit->FixParameter(1, parB);
	   total_fit->FixParameter(2, parC);
	   total_fit->FixParameter(3, parD);
	 }
       else
	 {
	   total_fit->FixParameter(0, parA);
  ...
  //  total_fit->SetParLimits(12, 0, 1000);  // e
