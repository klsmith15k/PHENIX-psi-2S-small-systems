...
void rebinning_macro_yuehang()
{
  ...
  //std::string rebinned_filename[2] = {"yuehang_Run15pp_S_rebinned_3_gev.root","yuehang_Run15pp_N_rebinned_3_gev.root"};

  std::string rebinned_filename[2] = {"/phenix/hhj/klsmith/Jpsis/Run15pAu/fit_NOFVTX/krista_fits/tony_bestfit_parameters/yuehang_corrbg/yuehang_Run15pp_S_rebinned_300mev.root","/phenix/hhj/klsmith/Jpsis/Run15pAu/fit_NOFVTX/krista_fits/tony_bestfit_parameters/yuehang_corrbg/yuehang_Run15pp_N_rebinned_300mev.root"};
