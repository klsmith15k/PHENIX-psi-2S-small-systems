...
void rebinning_macro_ptint_cent()
{
  ...
  if(North == true)
    {
      sprintf(name4,"psi2S_root_files/check_fvtx_badprobcut_root5_nofvtxchi2_noZ_fid188N_N.root");
      fout = new TFile(name4, "RECREATE");	  
      //   file_data = TFile::Open("matt_centrality_macros/CONDOR/sng_root5_badprob_nofid/result.root");
      //  file_data = TFile::Open("psi2S_root_files/test_fvtx.root");
      file_data = TFile::Open("matt_centrality_macros/CONDOR/fvtx_badprobcut_root5_nofvtxchi2_noZ_fid188N/result.root");

      //  file_data = TFile::Open("matt_centrality_macros/check2.root");
       //  file_data = TFile::Open("matt_centrality_macros/CONDOR/jobfiles_228_fvtx/result.root");
    }
else
    {
      sprintf(name4,"psi2S_root_files/check_fvtx_badprobcut_root5_nofvtxchi2_noZ_fid188N_S.root");
      fout = new TFile(name4, "RECREATE");	  
      //  file_data = TFile::Open("matt_centrality_macros/CONDOR/sng_root5_badprob_nofid/result.root");
      //   file_data = TFile::Open("psi2S_root_files/test_fvtx.root");
      file_data = TFile::Open("matt_centrality_macros/CONDOR/fvtx_badprobcut_root5_nofvtxchi2_noZ_fid188N/result.root");
      ...
      //file_data = TFile::Open("matt_centrality_macros/check2.root");
	// file_data = TFile::Open("matt_centrality_macros/CONDOR/jobfiles_228_sng/result.root");
 }
 
  TH1D *ul[5];  // only works if arrays are constant static integers
  TH1D *pp[5];
  TH1D *mm[5];
  TH1D *mix_ul[5];
  ...
  if(North == true)
    {
      ...
      // file_data->GetObject("mass_fvtx_pt_510_N_ul",t[1]);
      // file_data->GetObject("mass_fvtx_pt_510_N_pp",u[1]);
      // file_data->GetObject("mass_fvtx_pt_510_N_mm",v[1]);
      //  file_data->GetObject("mass_fvtx_pt_510_N_mix",w[1]);

      // file_data->GetObject("mass_fvtx_pt_010_N_ul",t[2]);
      // file_data->GetObject("mass_fvtx_pt_010_N_pp",u[2]);
      // file_data->GetObject("mass_fvtx_pt_010_N_mm",v[2]);
      //  file_data->GetObject("mass_fvtx_pt_010_N_mix",w[2]);

      // file_data->GetObject("mass_fvtx_pt_1020_N_ul",t[3]);
      // file_data->GetObject("mass_fvtx_pt_1020_N_pp",u[3]);
      // file_data->GetObject("mass_fvtx_pt_1020_N_mm",v[3]);
      //  file_data->GetObject("mass_fvtx_pt_1020_N_mix",w[3]);
	
      // file_data->GetObject("mass_fvtx_pt_020_N_ul",t[4]);
      // file_data->GetObject("mass_fvtx_pt_020_N_pp",u[4]);
      // file_data->GetObject("mass_fvtx_pt_020_N_mm",v[4]);
      // file_data->GetObject("mass_fvtx_pt_020_N_mix",w[4]);

      // file_data->GetObject("mass_fvtx_pt_2040_N_ul",t[5]);
      // file_data->GetObject("mass_fvtx_pt_2040_N_pp",u[5]);
      // file_data->GetObject("mass_fvtx_pt_2040_N_mm",v[5]);
      //  file_data->GetObject("mass_fvtx_pt_2040_N_mix",w[5]);

      // file_data->GetObject("mass_fvtx_pt_4060_N_ul",t[6]);
      // file_data->GetObject("mass_fvtx_pt_4060_N_pp",u[6]);
      // file_data->GetObject("mass_fvtx_pt_4060_N_mm",v[6]);
      //   file_data->GetObject("mass_fvtx_pt_4060_N_mix",w[6]);
  ...
  else
    {
      ...
      // file_data->GetObject("mass_fvtx_pt_510_S_ul",t[1]);
      // file_data->GetObject("mass_fvtx_pt_510_S_pp",u[1]);
      // file_data->GetObject("mass_fvtx_pt_510_S_mm",v[1]);
      // file_data->GetObject("mass_fvtx_pt_510_S_mix",w[1]);

      // file_data->GetObject("mass_fvtx_pt_010_S_ul",t[2]);
      // file_data->GetObject("mass_fvtx_pt_010_S_pp",u[2]);
      // file_data->GetObject("mass_fvtx_pt_010_S_mm",v[2]);
      // file_data->GetObject("mass_fvtx_pt_010_S_mix",w[2]);

      // file_data->GetObject("mass_fvtx_pt_1020_S_ul",t[3]);
      // file_data->GetObject("mass_fvtx_pt_1020_S_pp",u[3]);
      // file_data->GetObject("mass_fvtx_pt_1020_S_mm",v[3]);
      //  file_data->GetObject("mass_fvtx_pt_1020_S_mix",w[3]);

      // file_data->GetObject("mass_fvtx_pt_020_S_ul",t[4]);
      // file_data->GetObject("mass_fvtx_pt_020_S_pp",u[4]);
      // file_data->GetObject("mass_fvtx_pt_020_S_mm",v[4]);
      // file_data->GetObject("mass_fvtx_pt_020_S_mix",w[4]);

      // file_data->GetObject("mass_fvtx_pt_2040_S_ul",t[5]);
      // file_data->GetObject("mass_fvtx_pt_2040_S_pp",u[5]);
      // file_data->GetObject("mass_fvtx_pt_2040_S_mm",v[5]);
      //  file_data->GetObject("mass_fvtx_pt_2040_S_mix",w[5]);

      // file_data->GetObject("mass_fvtx_pt_4060_S_ul",t[6]);
      // file_data->GetObject("mass_fvtx_pt_4060_S_pp",u[6]);
      // file_data->GetObject("mass_fvtx_pt_4060_S_mm",v[6]);
      // file_data->GetObject("mass_fvtx_pt_4060_S_mix",w[6]);
