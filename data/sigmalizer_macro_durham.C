...
void sigmalizer_macro_durham()
{
  ...
  //TFile *file_data = new TFile("Run15pp_sng_local_pdst_drdthetadphi.root");
  // TFile *file_data = new TFile("local_ppg201_noprobcut_sept19.root");  
  TFile *file_data = new TFile("CONDOR/fvtx_batch108_new_sigmalizer/result.root");
 ...
 /////////////////////////////////// dphi north
  ...
  if(!TTreeReader)
    {
  cout<<"string dr_cut_N = \"Tr0_dr_fvtx<("<<dr_N_fit->GetParameter(0)<<"+"<<dr_N_fit->GetParameter(1)<<"/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))\ && Tr1_dr_fvtx<("<<dr_N_fit->GetParameter(0)<<"+"<<dr_N_fit->GetParameter(1)<<"/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))\";"<<endl;

  cout<<"string dr_cut_S = \"Tr0_dr_fvtx<("<<dr_S_fit->GetParameter(0)<<"+"<<dr_S_fit->GetParameter(1)<<"/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))\ && Tr1_dr_fvtx<("<<dr_S_fit->GetParameter(0)<<"+"<<dr_S_fit->GetParameter(1)<<"/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))\";"<<endl;

 cout<<"string dtheta_cut_N = \"Tr0_dtheta_fvtx<("<<dtheta_N_fit->GetParameter(0)<<"+"<<dtheta_N_fit->GetParameter(1)<<"/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))\ && Tr1_dtheta_fvtx<("<<dtheta_N_fit->GetParameter(0)<<"+"<<dtheta_N_fit->GetParameter(1)<<"/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))\";"<<endl;

cout<<"string dtheta_cut_S = \"Tr0_dtheta_fvtx<("<<dtheta_S_fit->GetParameter(0)<<"+"<<dtheta_S_fit->GetParameter(1)<<"/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))\ && Tr1_dtheta_fvtx<("<<dtheta_S_fit->GetParameter(0)<<"+"<<dtheta_S_fit->GetParameter(1)<<"/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))\";"<<endl;

 cout<<"string dphi_cut_N = \"Tr0_dphi_fvtx<("<<dphi_N_fit->GetParameter(0)<<"+"<<dphi_N_fit->GetParameter(1)<<"/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))\ && Tr1_dphi_fvtx<("<<dphi_N_fit->GetParameter(0)<<"+"<<dphi_N_fit->GetParameter(1)<<"/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))\";"<<endl;

cout<<"string dphi_cut_S = \"Tr0_dphi_fvtx<("<<dphi_S_fit->GetParameter(0)<<"+"<<dphi_S_fit->GetParameter(1)<<"/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))\ && Tr1_dphi_fvtx<("<<dphi_S_fit->GetParameter(0)<<"+"<<dphi_S_fit->GetParameter(1)<<"/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))\";"<<endl;


  

cout<<"string DG0_cut_N = \"Tr0_DG0<("<<DG0_N_fit->GetParameter(0)<<"+"<<DG0_N_fit->GetParameter(1)<<"/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))\ && Tr1_DG0<("<<DG0_N_fit->GetParameter(0)<<"+"<<DG0_N_fit->GetParameter(1)<<"/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))\";"<<endl;

cout<<"string DG0_cut_S = \"Tr0_DG0<("<<DG0_S_fit->GetParameter(0)<<"+"<<DG0_S_fit->GetParameter(1)<<"/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))\ && Tr1_DG0<("<<DG0_S_fit->GetParameter(0)<<"+"<<DG0_S_fit->GetParameter(1)<<"/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))\";"<<endl;

cout<<"string DDG0_cut_N = \"Tr0_DDG0<("<<DDG0_N_fit->GetParameter(0)<<"+"<<DDG0_N_fit->GetParameter(1)<<"/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))\ && Tr1_DDG0<("<<DDG0_N_fit->GetParameter(0)<<"+"<<DDG0_N_fit->GetParameter(1)<<"/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))\";"<<endl;

cout<<"string DDG0_cut_S = \"Tr0_DDG0<("<<DDG0_S_fit->GetParameter(0)<<"+"<<DDG0_S_fit->GetParameter(1)<<"/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))\ && Tr1_DDG0<("<<DDG0_S_fit->GetParameter(0)<<"+"<<DDG0_S_fit->GetParameter(1)<<"/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))\";"<<endl;

    }
  ///////////////////////////////////////////////////////////////////////////////////////////
  if(TTreeReader)
    {
cout<<" dr_cut_N = Tr0_dr_fvtx[i]<("<<dr_N_fit->GetParameter(0)<<"+"<<dr_N_fit->GetParameter(1)<<"/(px_Tr0[i] * px_Tr0[i] + py_Tr0[i]*py_Tr0[i] + pz_Tr0[i]*pz_Tr0[i])) && Tr1_dr_fvtx[i]<("<<dr_N_fit->GetParameter(0)<<"+"<<dr_N_fit->GetParameter(1)<<"/(px_Tr1[i] * px_Tr1[i] + py_Tr1[i]*py_Tr1[i] + pz_Tr1[i]*pz_Tr1[i]));"<<endl;

  cout<<" dr_cut_S = Tr0_dr_fvtx[i]<("<<dr_S_fit->GetParameter(0)<<"+"<<dr_S_fit->GetParameter(1)<<"/(px_Tr0[i] * px_Tr0[i] + py_Tr0[i]*py_Tr0[i] + pz_Tr0[i]*pz_Tr0[i])) && Tr1_dr_fvtx[i]<("<<dr_S_fit->GetParameter(0)<<"+"<<dr_S_fit->GetParameter(1)<<"/(px_Tr1[i] * px_Tr1[i] + py_Tr1[i]*py_Tr1[i] + pz_Tr1[i]*pz_Tr1[i]));"<<endl;

 cout<<" dtheta_cut_N = Tr0_dtheta_fvtx[i]<("<<dtheta_N_fit->GetParameter(0)<<"+"<<dtheta_N_fit->GetParameter(1)<<"/(px_Tr0[i] * px_Tr0[i] + py_Tr0[i]*py_Tr0[i] + pz_Tr0[i]*pz_Tr0[i])) && Tr1_dtheta_fvtx[i]<("<<dtheta_N_fit->GetParameter(0)<<"+"<<dtheta_N_fit->GetParameter(1)<<"/(px_Tr1[i] * px_Tr1[i] + py_Tr1[i]*py_Tr1[i] + pz_Tr1[i]*pz_Tr1[i]));"<<endl;

cout<<" dtheta_cut_S = Tr0_dtheta_fvtx[i]<("<<dtheta_S_fit->GetParameter(0)<<"+"<<dtheta_S_fit->GetParameter(1)<<"/(px_Tr0[i] * px_Tr0[i] + py_Tr0[i]*py_Tr0[i] + pz_Tr0[i]*pz_Tr0[i])) && Tr1_dtheta_fvtx[i]<("<<dtheta_S_fit->GetParameter(0)<<"+"<<dtheta_S_fit->GetParameter(1)<<"/(px_Tr1[i] * px_Tr1[i] + py_Tr1[i]*py_Tr1[i] + pz_Tr1[i]*pz_Tr1[i]));"<<endl;

 cout<<" dphi_cut_N = Tr0_dphi_fvtx[i]<("<<dphi_N_fit->GetParameter(0)<<"+"<<dphi_N_fit->GetParameter(1)<<"/(px_Tr0[i] * px_Tr0[i] + py_Tr0[i]*py_Tr0[i] + pz_Tr0[i]*pz_Tr0[i])) && Tr1_dphi_fvtx[i]<("<<dphi_N_fit->GetParameter(0)<<"+"<<dphi_N_fit->GetParameter(1)<<"/(px_Tr1[i] * px_Tr1[i] + py_Tr1[i]*py_Tr1[i] + pz_Tr1[i]*pz_Tr1[i]));"<<endl;

cout<<" dphi_cut_S = Tr0_dphi_fvtx[i]<("<<dphi_S_fit->GetParameter(0)<<"+"<<dphi_S_fit->GetParameter(1)<<"/(px_Tr0[i] * px_Tr0[i] + py_Tr0[i]*py_Tr0[i] + pz_Tr0[i]*pz_Tr0[i])) && Tr1_dphi_fvtx[i]<("<<dphi_S_fit->GetParameter(0)<<"+"<<dphi_S_fit->GetParameter(1)<<"/(px_Tr1[i] * px_Tr1[i] + py_Tr1[i]*py_Tr1[i] + pz_Tr1[i]*pz_Tr1[i]));"<<endl;


  

cout<<"DG0_N = DG0_Tr0[i]<("<<DG0_N_fit->GetParameter(0)<<"+"<<DG0_N_fit->GetParameter(1)<<"/(px_Tr0[i] * px_Tr0[i] + py_Tr0[i]*py_Tr0[i] + pz_Tr0[i]*pz_Tr0[i])) && DG0_Tr1[i]<("<<DG0_N_fit->GetParameter(0)<<"+"<<DG0_N_fit->GetParameter(1)<<"/(px_Tr1[i] * px_Tr1[i] + py_Tr1[i]*py_Tr1[i] + pz_Tr1[i]*pz_Tr1[i]));"<<endl;

 cout<<" DG0_S = DG0_Tr0[i]<("<<DG0_S_fit->GetParameter(0)<<"+"<<DG0_S_fit->GetParameter(1)<<"/(px_Tr0[i] * px_Tr0[i] + py_Tr0[i]*py_Tr0[i] + pz_Tr0[i]*pz_Tr0[i])) && DG0_Tr1[i]<("<<DG0_S_fit->GetParameter(0)<<"+"<<DG0_S_fit->GetParameter(1)<<"/(px_Tr1[i] * px_Tr1[i] + py_Tr1[i]*py_Tr1[i] + pz_Tr1[i]*pz_Tr1[i]));"<<endl;

cout<<" DDG0_N = DDG0_Tr0[i]<("<<DDG0_N_fit->GetParameter(0)<<"+"<<DDG0_N_fit->GetParameter(1)<<"/(px_Tr0[i] * px_Tr0[i] + py_Tr0[i]*py_Tr0[i] + pz_Tr0[i]*pz_Tr0[i])) && DDG0_Tr1[i]<("<<DDG0_N_fit->GetParameter(0)<<"+"<<DDG0_N_fit->GetParameter(1)<<"/(px_Tr1[i] * px_Tr1[i] + py_Tr1[i]*py_Tr1[i] + pz_Tr1[i]*pz_Tr1[i]));"<<endl;

cout<<" DDG0_S = DDG0_Tr0[i]<("<<DDG0_S_fit->GetParameter(0)<<"+"<<DDG0_S_fit->GetParameter(1)<<"/(px_Tr0[i] * px_Tr0[i] + py_Tr0[i]*py_Tr0[i] + pz_Tr0[i]*pz_Tr0[i])) && DDG0_Tr1[i]<("<<DDG0_S_fit->GetParameter(0)<<"+"<<DDG0_S_fit->GetParameter(1)<<"/(px_Tr1[i] * px_Tr1[i] + py_Tr1[i]*py_Tr1[i] + pz_Tr1[i]*pz_Tr1[i]));"<<endl;
