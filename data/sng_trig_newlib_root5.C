...
ifstream run_files2(filename[1].c_str() );
 ...
 // cuts from good runs only
  string DG0_cut_N1 = " ((Tr0_nhits_fvtx > 0) && (Tr0_DG0<(8.14581+106.858/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))))";
  string DG0_cut_S1 = " ((Tr0_nhits_fvtx > 0) && (Tr0_DG0<(8.93709+366.856/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))))";
  string DDG0_cut_N1 = " ((Tr0_nhits_fvtx > 0) && (Tr0_DDG0<(4.3602+142.651/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))))";
  string DDG0_cut_S1 = " ((Tr0_nhits_fvtx > 0) && (Tr0_DDG0<(4.66658+120.627/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz))))";

  string DG0_cut_N2 = " ((Tr1_nhits_fvtx > 0) && (Tr1_DG0<(8.14581+106.858/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))))";
  string DG0_cut_S2 = "((Tr1_nhits_fvtx > 0) && (Tr1_DG0<(8.93709+366.856/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))))";
  string DDG0_cut_N2 = "((Tr1_nhits_fvtx > 0) && (Tr1_DDG0<(4.3602+142.651/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))))";
  string DDG0_cut_S2 = " ((Tr1_nhits_fvtx > 0) && (Tr1_DDG0<(4.66658+120.627/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz))))";
...
// cuts from only good runs
  string dr_cut_N1 = "(Tr0_nhits_fvtx > 0) && (Tr0_dr_fvtx<(1.76048+23.9016/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz)))";
  string dr_cut_S1 = "(Tr0_nhits_fvtx > 0) && (Tr0_dr_fvtx<(1.39017+29.279/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz)))";
  string dtheta_cut_N1 = "(Tr0_nhits_fvtx > 0) && (Tr0_dtheta_fvtx<(0.0499702+0.694368/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz)))";
  string dtheta_cut_S1 = "(Tr0_nhits_fvtx > 0) && (Tr0_dtheta_fvtx<(0.0555553+0.557225/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz)))";
  string dphi_cut_N1 = "(Tr0_nhits_fvtx > 0) && (Tr0_dphi_fvtx<(0.11936+1.44372/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz)))";
  string dphi_cut_S1 = "(Tr0_nhits_fvtx > 0) && (Tr0_dphi_fvtx<(0.116105+1.51064/(Tr0_px * Tr0_px + Tr0_py*Tr0_py + Tr0_pz*Tr0_pz)))";

  string dr_cut_N2 = " (Tr1_nhits_fvtx > 0) && (Tr1_dr_fvtx<(1.76048+23.9016/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz)))";
  string dr_cut_S2 = "(Tr1_nhits_fvtx > 0) && (Tr1_dr_fvtx<(1.39017+29.279/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz)))";
  string dtheta_cut_N2 = " (Tr1_nhits_fvtx > 0) && (Tr1_dtheta_fvtx<(0.0499702+0.694368/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz)))";
  string dtheta_cut_S2 = " (Tr1_nhits_fvtx > 0) && (Tr1_dtheta_fvtx<(0.0555553+0.557225/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz)))";
  string dphi_cut_N2 = "(Tr1_nhits_fvtx > 0) && (Tr1_dphi_fvtx<(0.11936+1.44372/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz)))";
  string dphi_cut_S2 = " (Tr1_nhits_fvtx > 0) && (Tr1_dphi_fvtx<(0.116105+1.51064/(Tr1_px * Tr1_px + Tr1_py*Tr1_py + Tr1_pz*Tr1_pz)))";
  ...
  string cuts_N1 = "&&" + rap_cut_N  + "&&" + pz_cut_N + "&&"+ mass_cut + "&&" + evt_cut_N + "&&" + muon_arm_cut_N1 + "&&" + dr_cut_N1 + "&&" + dtheta_cut_N1 + "&&" + dphi_cut_N1 + "&&" + sng_trk_vtx1;
  string cuts_S1 = "&&" + rap_cut_S  + "&&" + pz_cut_S + "&&" + mass_cut + "&&" + evt_cut_S + "&&" + muon_arm_cut_S1 + "&&" + dr_cut_S1 + "&&" + dtheta_cut_S1 + "&&" + dphi_cut_S1 + "&&" + sng_trk_vtx1;

  string cuts_N2 = "&&" + rap_cut_N  + "&&" + pz_cut_N + "&&"+ mass_cut + "&&" + evt_cut_N + "&&" + muon_arm_cut_N2 + "&&" + dr_cut_N2 + "&&" + dtheta_cut_N2 + "&&" + dphi_cut_N2 + "&&" + sng_trk_vtx2;
  string cuts_S2 = "&&" + rap_cut_S  + "&&"  + pz_cut_S + "&&" + mass_cut + "&&" + evt_cut_S + "&&"+ muon_arm_cut_S2 + "&&" + dr_cut_S2 + "&&" + dtheta_cut_S2 + "&&" + dphi_cut_S2 + "&&" + sng_trk_vtx2;
