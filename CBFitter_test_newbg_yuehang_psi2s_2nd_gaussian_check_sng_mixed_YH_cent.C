...
Double_t CBcalc_jpsi(Double_t *xx, Double_t *par)  // CB fucntion for J/psi 
{
  ...
  if(north_arm)
    ratio = 118.938/3181.51;
  else
    ratio = 129.562/2239.58;

  if(north_arm)
    fraction = 0.281/0.11279;
  else
    fraction = 0.281/0.12319;
...
void CBFitter_test_newbg_yuehang_psi2s_2nd_gaussian_check_sng_mixed_YH_cent()
{
	...
	{     
	  if(special == 0)
	      ...
	      else 
		{
		  ...
		  file1S = TFile::Open("psi2S_root_files/Run15pp_sng_psi2S_final_N.root");
	    ...
	    {
	      if(pt_bin == 2)
		file1S = TFile::Open("Run15pAu_N_rebinned_PPG_binwidth_special_2.root"); 
	    } // special == 1
      ...
      else
	{
	  if(special == 0)
	      ...
	      else      
		{
		  ...
		  file1S = TFile::Open("psi2S_root_files/Run15pp_sng_psi2S_final_S.root");  // made with pDST files that included bad prob cut only.  
	    ...
	    {
	     if(pt_bin == 2)
		file1S = TFile::Open("Run15pAu_S_rebinned_PPG_binwidth_special_2.root"); 
	    } // special == 1
 ...
 Double_t Npsi2s,err_psi2s;
   ...
   //////////////////////////////////////////////////////////////////////   
    ...
    if(north_arm) 
   ...
   else
     {
       ...
       total_fit->SetParLimits(0, 0, 2);
       total_fit->SetParameter(1, f1);
       total_fit->SetParLimits(1, 0, 10);   // these limits are correct for south arm psi2s toy sim fit
     }
   //////////////////////////////////////////////////////////////////////   
  ...
  if(fixed_corr_bg == true)
	...
	sprintf(name100,"tony_bestfit_parameters/yuehang_bestfit_500mev/bestfit_parameters_N_14.dat");
      ...
      ifstream Run15pAu_testfit(name100);
      if(Run15pAu_testfit)
	{
	  do 
	    {
	      double f0, f1, f2, f3, f4, f5, f6, f7, f8, f9;	  
	      Run15pAu_testfit >> f0 >> f1 >> f2 >> f3 >> f4 >> f5 >> f6 >> f7 >> f8 >> f9;
	      a = f0; a_err = f1; b = f2; b_err = f3; c = f4; c_err = f5; d = f6; d_err = f7; e = f8; e_err = f9;
	      cout << "c: " << c << endl;
	    } while(Run15pAu_testfit.good());
	}
      else
  ...
  //    std::fstream Run15pAu_width(name3500,std::ofstream::out); 
  //     Run15pAu_width >>  NJpsi >> " " >>  err_NJpsi >> " " >> Npsi2s >> " " >> err_psi2s >> " " >> Npsi2s/NJpsi >> " " >> chisquare >> " " >> chisquare/ndf >> " " >> fixed >> " " >> CB_mean >> " " >> alpha >> " " >> n >> " " >> sigma >> " " >> N << " " << endl;
  //     Run15pAu_width.close();
...
// write
  ...
  if(width_write)
	...
	{
	  if(north_arm)
	    sprintf(name200,"tony_bestfit_parameters/sanghoon_corrbg/jpsi_widths/Run15pAu_N_width_%i.dat", bin);	 
	  else
	    sprintf(name200,"tony_bestfit_parameters/sanghoon_corrbg/jpsi_widths/Run15pAu_S_width_%i.dat", bin);	  
	}
      if(bin_width == 2)
	{
	  if(north_arm && bin == 13)
	    sprintf(name200,"tony_bestfit_parameters/sanghoon_corrbg/jpsi_widths/Run15pAu_N_width_25.dat");
	  if(north_arm && bin == 14)
	    sprintf(name200,"tony_bestfit_parameters/sanghoon_corrbg/jpsi_widths/Run15pAu_N_width_26.dat");
	  if(!north_arm && bin == 13)
	    sprintf(name200,"tony_bestfit_parameters/sanghoon_corrbg/jpsi_widths/Run15pAu_S_width_25.dat");
	  if(!north_arm && bin == 14)
	    sprintf(name200,"tony_bestfit_parameters/sanghoon_corrbg/jpsi_widths/Run15pAu_S_width_26.dat");
	}
      ...
      // whether north arm or south arm, write to unique filename  
      std::fstream Run15pAu_width(name200,std::ofstream::out); 
      Run15pAu_width <<  a << " " << b << " " << endl;
      Run15pAu_width.close();
  ...
  if(write_pAl_syst_err)
	...
	{
	  if(bin < 25)
	    sprintf(name200,"tony_bestfit_parameters/sanghoon_corrbg/pAl_syst_err_yields/Run15pAu_N_yield_%i.dat", bin);
	  if(bin == 13 && bin_width == 2)
	    sprintf(name200,"tony_bestfit_parameters/sanghoon_corrbg/pAl_syst_err_yields/Run15pAu_N_yield_25.dat");
	  if(bin == 14 && bin_width == 2)
	    sprintf(name200,"tony_bestfit_parameters/sanghoon_corrbg/pAl_syst_err_yields/Run15pAu_N_yield_26.dat");
	}
      else
	{
	  if(bin < 25)
	    sprintf(name200,"tony_bestfit_parameters/sanghoon_corrbg/pAl_syst_err_yields/Run15pAu_S_yield_%i.dat", bin);	
	  if(bin == 13 && bin_width == 2)
	    sprintf(name200,"tony_bestfit_parameters/sanghoon_corrbg/pAl_syst_err_yields/Run15pAu_S_yield_25.dat");
	  if(bin == 14 && bin_width == 2)
	    sprintf(name200,"tony_bestfit_parameters/sanghoon_corrbg/pAl_syst_err_yields/Run15pAu_S_yield_26.dat");
	}  
    

      // whether north arm or south arm, write to unique filename  
      std::fstream Run15pAu_yield(name200,std::ofstream::out); 
      Run15pAu_yield <<  NJpsi << " " << err_NJpsi << " " << endl;
      Run15pAu_yield.close();
...
TLegend *leg2 = new TLegend(0.65, 0.52, 0.84, 0.74);  //(start x, start y, end x, end y)
  ...
  if(write == true)
      ...
      if(north_arm)
	{
	  if(bin_width == 1 && special == 0)
	    {
	      if(CaseF == true)
		sprintf(nameN,"tony_bestfit_parameters/CaseF/Run15pAu_N_bestfit_parameters_tony_1_%i.dat",bin); 
	      if(CaseG == true)
		sprintf(nameN,"tony_bestfit_parameters/CaseG/Run15pAu_N_bestfit_parameters_tony_1_%i.dat",bin); 
	      if(CaseH == true)
		sprintf(nameN,"tony_bestfit_parameters/CaseH/Run15pAu_N_bestfit_parameters_tony_1_%i.dat",bin); 
	      if(CaseA == true)
		{
		  sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/CaseA/Run15pAu_N_bestfit_parameters_tony_1_%i.dat",bin); 
		  sprintf(nameN2,"tony_bestfit_parameters/sanghoon_corrbg/pAu_yields/Run15pAu_N_bestfit_parameters_tony_1_%i.dat",bin); 
		  // if(bin < 17)
		  // sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/pAl_yields/Run15pAu_N_bestfit_parameters_tony_1_%i.dat",bin); 
		  // if(bin < 17)
		  // sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/HeAu_yields/Run15pAu_N_bestfit_parameters_tony_1_%i.dat",bin); 
		}
	    }
	  if(bin_width == 2  && special == 0)
	    {
	      if(CaseF == true)
		sprintf(nameN,"tony_bestfit_parameters/CaseF/Run15pAu_N_bestfit_parameters_tony_2_%i.dat",bin); 
	      if(CaseG == true)
		sprintf(nameN,"tony_bestfit_parameters/CaseG/Run15pAu_N_bestfit_parameters_tony_2_%i.dat",bin); 
	      if(CaseH == true)
		sprintf(nameN,"tony_bestfit_parameters/CaseH/Run15pAu_N_bestfit_parameters_tony_2_%i.dat",bin); 
	      if(CaseA == true)
		{
		  if(bin == 13)
		    sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/CaseA/Run15pAu_N_bestfit_parameters_tony_1_25.dat"); 
		  if(bin == 14)
		    sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/CaseA/Run15pAu_N_bestfit_parameters_tony_1_26.dat"); 
		  // for centrality binning
		  // if(bin == 6 && HeAu)
		  //   sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/HeAu_yields/Run15pAu_N_bestfit_parameters_tony_1_11.dat"); 
		  // if(bin == 7 && HeAu)
		  //   sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/HeAu_yields/Run15pAu_N_bestfit_parameters_tony_1_12.dat"); 
		  // if(bin == 8 && HeAu)
		  //   sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/HeAu_yields/Run15pAu_N_bestfit_parameters_tony_1_13.dat"); 
		  if(bin == 9 && pAu)
		    sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/pAu_yields/Run15pAu_N_bestfit_parameters_tony_1_17.dat"); 
		  if(bin == 10 && pAu)
		    sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/pAu_yields/Run15pAu_N_bestfit_parameters_tony_1_18.dat"); 
		}
	    }
	  if(bin_width == 4 && pAl)
	    sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/0100_pAl_yields/Run15pAu_N_bestfit_parameters_tony_4_%i.dat",bin); 
	  if(bin == 3 && special == 1 && pAu)
	    sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/pAu_yields/Run15pAu_N_bestfit_parameters_tony_1_19.dat"); 
	  if(bin == 3 && special == 1 && HeAu)
	    sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/0100_HeAu_yields/Run15pAu_N_bestfit_parameters_tony_1_19.dat"); 
	 if(bin == 5 && bin_width == 4 && HeAu)
	    sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/HeAu_yields/Run15pAu_N_bestfit_parameters_tony_1_14.dat"); 
	  
	  std::fstream Run15pAu_N_bestfit_parameters_tony(nameN,std::ofstream::out); 
	  Run15pAu_N_bestfit_parameters_tony <<  f0  <<  " " << f1 << " " <<  f2 <<  " " << f3 << " " << f4 << " " <<  f5 << " " << f6 << " "  <<  f7 << " " << f8 << " " << f9 << " " << NJpsi  << " " << err_NJpsi << " " << chisquare << " " << ndf << " " << endl;
	  Run15pAu_N_bestfit_parameters_tony.close();
	}
      else
	{
	  if(bin_width == 1  && special == 0)
	    {
	      if(CaseF == true)
		sprintf(nameS,"tony_bestfit_parameters/CaseF/Run15pAu_S_bestfit_parameters_tony_1_%i.dat",bin); 
	      if(CaseG == true)
		sprintf(nameS,"tony_bestfit_parameters/CaseG/Run15pAu_S_bestfit_parameters_tony_1_%i.dat",bin); 
	      if(CaseH == true)
		sprintf(nameS,"tony_bestfit_parameters/CaseH/Run15pAu_S_bestfit_parameters_tony_1_%i.dat",bin); 
	      if(CaseA == true)
		{
		  sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/CaseA/Run15pAu_S_bestfit_parameters_tony_1_%i.dat",bin); 
		  sprintf(nameS2,"tony_bestfit_parameters/sanghoon_corrbg/pAu_yields/Run15pAu_S_bestfit_parameters_tony_1_%i.dat",bin); 
		  // if(bin < 17)
		  //  sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/pAl_yields/Run15pAu_S_bestfit_parameters_tony_1_%i.dat",bin); 
		  // if(bin < 17)
		  //  sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/HeAu_yields/Run15pAu_S_bestfit_parameters_tony_1_%i.dat",bin); 
		}
	      if(bin == 29 && CaseF)
		sprintf(nameS,"tony_bestfit_parameters/pt_int/CaseF/Run15pAu_S_bestfit_parameters_tony_1_%i.dat",bin); 
	      if(bin == 29 && CaseG)
		sprintf(nameS,"tony_bestfit_parameters/pt_int/CaseG/Run15pAu_S_bestfit_parameters_tony_1_%i.dat",bin); 
	      if(bin == 29 && CaseH)
		sprintf(nameS,"tony_bestfit_parameters/pt_int/CaseH/Run15pAu_S_bestfit_parameters_tony_1_%i.dat",bin); 
	    }
	  
	  if(bin_width == 2  && special == 0)
	    {
	      if(CaseF == true)
		sprintf(nameS,"tony_bestfit_parameters/CaseF/Run15pAu_S_bestfit_parameters_tony_2_%i.dat",bin); 
	      if(CaseG == true)
		sprintf(nameS,"tony_bestfit_parameters/CaseG/Run15pAu_S_bestfit_parameters_tony_2_%i.dat",bin); 
	      if(CaseH == true)
		sprintf(nameS,"tony_bestfit_parameters/CaseH/Run15pAu_S_bestfit_parameters_tony_2_%i.dat",bin); 
	      if(CaseA == true)
		{
		  if(bin == 13)
		    sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/CaseA/Run15pAu_S_bestfit_parameters_tony_1_25.dat"); 
		  if(bin == 14)
		    sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/CaseA/Run15pAu_S_bestfit_parameters_tony_1_26.dat"); 
		  // for centrality binning
		  // if(bin == 6 && HeAu)
		  //   sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/HeAu_yields/Run15pAu_S_bestfit_parameters_tony_1_11.dat"); 
		  // if(bin == 7 && HeAu)
		  //   sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/HeAu_yields/Run15pAu_S_bestfit_parameters_tony_1_12.dat"); 
		  // if(bin == 8 && HeAu)
		  //   sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/HeAu_yields/Run15pAu_S_bestfit_parameters_tony_1_13.dat"); 
		  if(bin == 9 && pAu)
		    sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/pAu_yields/Run15pAu_S_bestfit_parameters_tony_1_17.dat"); 
		  if(bin == 10 && pAu)
		    sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/pAu_yields/Run15pAu_S_bestfit_parameters_tony_1_18.dat"); 
		}
	    }
	  
	  if(bin_width == 4)
	    sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/0100_pAl_yields/Run15pAu_S_bestfit_parameters_tony_4_%i.dat",bin); 
	  if(bin == 3 && special == 1 && pAu)
	    sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/pAu_yields/Run15pAu_S_bestfit_parameters_tony_1_19.dat"); 
	  if(bin == 3 && special == 1 && HeAu)
	    sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/0100_HeAu_yields/Run15pAu_S_bestfit_parameters_tony_1_19.dat"); 
	  if(bin == 5 && bin_width == 4 && HeAu)
	    sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/HeAu_yields/Run15pAu_S_bestfit_parameters_tony_1_14.dat"); 

	  std::fstream Run15pAu_S_bestfit_parameters_tony(nameS,std::ofstream::out); 
	  Run15pAu_S_bestfit_parameters_tony <<  f0  <<  " " << f1 << " " <<  f2 <<  " " << f3 << " " << f4 << " " <<  f5 << " " << f6 << " "  <<  f7 << " " << f8 << " " << f9 << " " << NJpsi  << " " << err_NJpsi << " " << chisquare << " " << ndf << " " << endl;  //NJpsi is covariant
	  Run15pAu_S_bestfit_parameters_tony.close();
	}
    }
 ...
 if(ppg188)
    {
      if(north_arm == true)
	//	sprintf(text3,"North p_{T} Int. (Local), SNG");
      sprintf(text3,"North p_{T} Int, PPG188 ");
      if(north_arm == false)
	//	sprintf(text3,"South p_{T} Int. (Local), SNG");
...
Double_t CBcalc_jpsi(Double_t *xx, Double_t *par)  // CB fucntion for J/psi 
{
  ...
  // //new lib values
  // if(north_arm)
  //   ratio = 319.53/779.525;
  // else
  //   ratio = 121.595/466.009;

  // if(north_arm)
  //   fraction = 0.15/0.09377;
  // else
  //   fraction = 0.21/0.11706;

 
  //  if(north_arm)
  //   ratio = 163.558/3222.09;
  // else
  //   ratio = 277.634/3028.32;

  // if(north_arm)
  //    fraction = 0.247/0.11195;
  //  else
  //    fraction = 0.247/0.12175;


   if(north_arm)
     ratio = 102.659/3269.1;
  else
    ratio = 543.903/2791.05;

  if(north_arm)
    fraction = 0.287/0.11382;
   else
     fraction = 0.209/0.11522;
	  ...
	  if(special == 0)
	    {
	      if(bin_width == 4) 
		{
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_pro108_local_sng_dimu_02_int.root");
		  //  file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_PPG188_binwidth_48.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_pro108_nosng_dimu_02.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_pro108_sngtrk_dimu_02.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_sng_dimu02_noprob_int.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_pro108_sng_sngtrk_dimu_02.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_sng_dimu02_noprob_int.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_sng_prob_only_centrality_dimu02_int.root");
		  //file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_sng_228_cent_mixed_int.root");

		  //  file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_105intersect108_mixed_local.root");
		  //  file1S = TFile::Open("psi2S_root_files/Run15pAu_local_pDST_v_1.56_mixed_N.root");
		  file1S = TFile::Open("psi2S_root_files/Red_v0_N.root");
		}
	      else if(bin_width == 8)
		{
		  //  	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_pro108_local_sng_dimu_02_int.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_PPG188_binwidth_48.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_pro108_nosng_dimu_02_2.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_pro108_sngtrk_dimu_02_2.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_sng_dimu02_noprob_int.root");
		  //  file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_pro108_sng_sngtrk_dimu_02_2.root");
		  //  file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_sng_dimu02_noprob_int.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_sng_prob_only_centrality_dimu02_int.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_sng_228_cent_mixed_int.root");
	      ...
	      else 
		{
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_pro108_local_sng_dimu_02_int.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_PPG188_binwidth_48.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_pro108_nosng_dimu_02_int.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_pro108_sngtrk_dimu_02_int.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_sng_dimu02_noprob_int.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_pro108_sng_sngtrk_dimu_02_int.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_mass_sng_dimu02_noprob_int.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_sng_prob_only_centrality_dimu02_int.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_N_rebinned_sng_228_cent_mixed_int.root");
		  ...
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_local_pDST_v_1.56_mixed_N.root");
		  //file1S = TFile::Open("psi2S_root_files/Red_v0_N.root");
		  //  file1S = TFile::Open("psi2S_root_files/Red_sng_105108_noprob_N.root");
		  //  file1S = TFile::Open("psi2S_root_files/Red_mutr_105108_noyhcuts_N.root");
		 
		  // file1S = TFile::Open("psi2S_root_files/YH_sng_shlimlib_result_N.root");
		  //file1S = TFile::Open("psi2S_root_files/trig_mixed_sng_228_result_N.root");
		  //  file1S = TFile::Open("psi2S_root_files/trig_mixed_sng_batch105108_result_N.root");
		  ...
		  // file1S = TFile::Open("psi2S_root_files/sng_newlib_notrig_N.root");
		  file1S = TFile::Open("psi2S_root_files/sng_newlib_root5_local_noprob_fid228_newZ_CHECK_N.root");
		}
	    } // special == 0
	  else
	    {
	  ...
	  if(special == 0)
	    {
	      if(bin_width == 4)
		{
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_pro108_local_sng_dimu_02_int.root");
		  //		file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_PPG188_binwidth_48.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_pro108_nosng_dimu_02.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_pro108_sngtrk_dimu_02.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_sng_dimu02_noprob_int.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_pro108_sng_sngtrk_dimu_02.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_sng_prob_only_centrality_dimu02_int.root");
		  //  file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_sng_228_cent_mixed_int.root");

		  //  file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_105intersect108_mixed_local.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_local_pDST_v_1.56_mixed_S.root");
		  file1S = TFile::Open("psi2S_root_files/Red_v0_S.root");
		}
	      else if(bin_width == 8)
		{
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_pro108_local_sng_dimu_02_int.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_PPG188_binwidth_48.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_pro108_nosng_dimu_02_2.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_pro108_sngtrk_dimu_02_2.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_sng_dimu02_noprob_int.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_pro108_sng_sngtrk_dimu_02_2.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_sng_prob_only_centrality_dimu02_int.root");
		  //  file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_sng_228_cent_mixed_int.root");
	      ...
	      else      
		{
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_pro108_local_sng_dimu_02_int.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_PPG188_binwidth_48.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_pro108_nosng_dimu_02_int.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_pro108_sngtrk_dimu_02_int.root");
		  //	file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_sng_dimu02_noprob_int.root");
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_mass_pro108_sng_sngtrk_dimu_02_int.root");
		  //  file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_sng_prob_only_centrality_dimu02_int.root");
		  //  file1S = TFile::Open("psi2S_root_files/Run15pAu_S_rebinned_sng_228_cent_mixed_int.root");
		  ...
		  // file1S = TFile::Open("psi2S_root_files/Run15pAu_local_pDST_v_1.56_mixed_S.root");
		  //  file1S = TFile::Open("psi2S_root_files/Red_v0_S.root");
		  // file1S = TFile::Open("psi2S_root_files/Red_sng_105108_noprob_S.root");
		  //  file1S = TFile::Open("psi2S_root_files/Red_mutr_105108_noyhcuts_S.root");
		 
		  // file1S = TFile::Open("psi2S_root_files/YH_sng_shlimlib_result_S.root");
		  // file1S = TFile::Open("psi2S_root_files/trig_mixed_sng_228_result_S.root");
		  //	  file1S = TFile::Open("psi2S_root_files/trig_mixed_sng_batch105018_result_S.root");
		  // file1S = TFile::Open("psi2S_root_files/newlib_v2_S.root");
		  //  file1S = TFile::Open("psi2S_root_files/sng_newlib_notrig_S.root");
		  file1S = TFile::Open("psi2S_root_files/sng_newlib_root5_local_noprob_fid228_newZ_CHECK_S.root");
		}
	    } // special == 0
	  else
	    {
