...
Double_t CBcalc_jpsi(Double_t *xx, Double_t *par)  // CB fucntion for J/psi 
{
  ...
  if(north_arm)
    ratio = 655.64/7743.38;
   else
     ratio = 680.601/5253.69;

  if(north_arm)
    fraction = 0.202/0.08814;
  else
    fraction = 0.202/0.09766;
	...
	{     
	  if(special == 0)
	      ...
	      else 
		{
		  ...
		  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		    file1S = TFile::Open("psi2S_root_files/Run15pp_fvtx_psi2S_final_N.root");     // result file
		  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      else
	{
	  if(special == 0)
	      ...
	      else      
		{
		  ...
		  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			  file1S = TFile::Open("psi2S_root_files/Run15pp_fvtx_psi2S_final_S.root");   // result file
		  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		
		  //	  file1S = TFile::Open("psi2S_root_files/check_fvtx_badprobcut_root5_nofvtxchi2_noZ_fid188N_S.root");
      ...
      if(north_arm)
	{
	  if(bin_width == 1 && special == 0)
	      ...
	      if(CaseA == true)
		{
		  ...
		  sprintf(nameN2,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/Run15pp_N_bestfit_parameters_tony_1_%i.dat",bin); 
		  // if(bin < 17)
	  ...
	  if(bin_width == 2  && special == 0)
	      ...
	      if(CaseA == true)
		{
		  ...
		  if(bin == 9 && pp)
		    sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/Run15pp_N_bestfit_parameters_tony_1_17.dat"); 
		  if(bin == 10 && pp)
		    sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/Run15pp_N_bestfit_parameters_tony_1_18.dat"); 
		}
	    }
	  if(bin_width == 4 && pAl)
	    sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/0100_pAl_yields/Run15pp_N_bestfit_parameters_tony_4_%i.dat",bin); 
	  if(bin == 3 && special == 1 && pp)
	    sprintf(nameN,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/Run15pp_N_bestfit_parameters_tony_1_19.dat"); 
      ...
      else
	{
	  if(bin_width == 1  && special == 0)
	      ...
	      if(CaseA == true)
		{
		  ...
		  sprintf(nameS2,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/Run15pp_S_bestfit_parameters_tony_1_%i.dat",bin); 
		  // if(bin < 17)
	  ...
	  if(bin_width == 2  && special == 0)
	      ...
	      if(CaseA == true)
		{
		  ...
		  if(bin == 9 && pp)
		    sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/Run15pp_S_bestfit_parameters_tony_1_17.dat"); 
		  if(bin == 10 && pp)
		    sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/Run15pp_S_bestfit_parameters_tony_1_18.dat"); 
		}
	    }
	  ...
	  if(bin == 3 && special == 1 && pp)
	    sprintf(nameS,"tony_bestfit_parameters/sanghoon_corrbg/pp_yields/Run15pp_S_bestfit_parameters_tony_1_19.dat"); 
	  if(bin == 3 && special == 1 && HeAu)
