...
void pAu_psi2S_ratio_ncoll_2bins()
{
    gROOT->ForceStyle();
...
double pAu_MB[narm][nbins] = {
 ...
 TFile *file_data1, *file_data2;
  ...
  TEfficiency *e2;
	...
	weight2 = cent_bin[1] * ncoll_228[1] / bias_228[1];
	weight3 = cent_bin[2] * ncoll_228[2] / bias_228[2];
	weight3 = cent_bin[3] * ncoll_228[3] / bias_228[3];

	jpsi_ppg228_pAu_inv_yield_3bins[arm][2] = (  ( jpsi_ppg228_pAu_inv_yield[arm][1] * weight1) + ( jpsi_ppg228_pAu_inv_yield[arm][2] * weight2) + (jpsi_ppg228_pAu_inv_yield[arm][3] * weight3 ) ) / (  weight1 + weight2 + weight3);
	jpsi_ppg228_pAu_inv_yield_3bins_err[arm][2] = ( ( jpsi_ppg228_pAu_inv_yield[arm][1] * weight1) +  (jpsi_ppg228_pAu_inv_yield_err[arm][2] * weight2) + (jpsi_ppg228_pAu_inv_yield_err[arm][3] * weight3 ) ) / (  weight1 + weight2 + weight3 );
 ...
 // // mixed events
  ...
  ///////////////////////////////////////////////////////////
    ...
    TGraphErrors *gr1 = new TGraphErrors(4,ncoll_array1,jpsi_ppg228[1],err_x,jpsi_ppg228_err[1]);
