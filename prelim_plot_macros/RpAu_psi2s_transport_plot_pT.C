...
void RpAu_psi2s_transport_plot_pT()
{
    gROOT->ForceStyle();
...
// 4a for sng+dbl psi2s
  ...
  //====================================================================================
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    {
      file_data1 = TFile::Open("/gpfs/mnt/gpfs02/phenix/hhj/hhj1/klsmith/Jpsis/Run15pAu/fit_NOFVTX/krista_fits/tony_bestfit_parameters/sanghoon_corrbg/xiaojian_psi2s_predictions/RpAu_2S_transport_0100.root");
      file_data1->GetObject("RpAu_2S_transport_0100_bkwd",p2);
      file_data1->GetObject("RpAu_2S_transport_0100_fwd",p1);
   ...
   for(int i = 0; i < 18; i++)
    ...
    //1 p3->SetFillColor(kRed+1);
    p1->SetFillColorAlpha(2,0.3);
    p1->SetLineWidth(3);

    p2->SetFillStyle(3001);
    p2->SetLineColor(kRed+2);
    //2 p4->SetFillColor(kRed+1);
    p2->SetFillColorAlpha(2,0.3);
    p2->SetLineWidth(3);
    ...
    TLegend *leg2 = new TLegend(0.20, 0.67, 0.44, 0.93);  //(start x, start y, end x, end y)
    ...
    if(north_arm)
      {
	leg2->AddEntry(p1,"#psi(2S) EPS09+Transport, Du & Rapp", "f");
	...
	//	leg2->AddEntry(p5,"CNM Effects (Du&Rapp)", "f");
      ...
      {
	leg2->AddEntry(p2,"#psi(2S) EPS09+Transport, Du & Rapp", "f");
    ...
    if(north_arm)
      c1->SaveAs(Form("../psi2S_pdf/RpAu_psi2s_rapp_plot_pT_fwd.pdf"));
    else
      c1->SaveAs(Form("../psi2S_pdf/RpAu_psi2s_rapp_plot_pT_bkwd.pdf"));
}
