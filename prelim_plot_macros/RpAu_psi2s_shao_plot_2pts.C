...
void RpAu_psi2s_shao_plot_2pts()
{
    gROOT->ForceStyle();
  ...
  const Double_t ncoll_array3[nbins] = {8.2,6.0,4.3,2.5};  // need all 4 points for ppg228 array
...
////////////////////////////// calcualte weighted MB sum
  ...
  //====================================================================================
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    {
       file_data1 = TFile::Open("psi2S_root_files/psi2s_RpAu_ncoll_shao_S.root");
       file_data1->GetObject("RpAu_ncteq_shao_ncoll_bkwd",p2);
       file_data1->GetObject("RpAu_epps_shao_ncoll_bkwd",p1);
   ...
   for(int i = 0; i < 4; i++)
    ...
    gr10_sys->SetMarkerColor(kBlue+1);                     
    gr10_sys->SetLineColor(kBlue+1);                         
 ...
 TCanvas *c1 = new TCanvas("c1","c1",0,0,800,545);
    ...
    gr10->SetMarkerColorAlpha(kBlue+1, 0.8);
    gr10->SetLineWidth(3);
    gr10->SetLineColorAlpha(kBlue+1, 0.8);
 ...
 // write TGraphs to same root file
  ...
  h = new TFile("RpAu_psi2s_shao_ncoll_S.root", "RECREATE");
