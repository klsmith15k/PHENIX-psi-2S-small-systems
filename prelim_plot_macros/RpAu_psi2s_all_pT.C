...
void RpAu_psi2s_all_pT()
{
  ...
  const Double_t pT_array1[nbins] = {0.25, 1.0, 2.0, 3.0, 4.5, 6.25};
...
// 4a for sng+dbl psi2s
  ...
  // individual 2nd gausian fits
    // double pp_sngdbl_psi2s[narm][nbins] = {
    //   {43, 218, 197, 11185, 11150, 138},  // 0.0 - 0.5, 0.5-1.5, 1.5-2.5, -, -, 2.5-4.5
    //   {13, 173, 166, 11148, 11159, 96}};
  ...
  //====================================================================================
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    {
      file_data3 = TFile::Open("/gpfs/mnt/gpfs02/phenix/hhj/hhj1/klsmith/Jpsis/Run15pAu/fit_NOFVTX/krista_fits/tony_bestfit_parameters/sanghoon_corrbg/xiaojian_psi2s_predictions/RpAu_2S_transport_MB_pT.root");
      file_data3->GetObject("RpAu_2S_transport_0100_bkwd",p5);
      file_data3->GetObject("RpAu_2S_transport_0100_fwd",p6);
 ...
 // Shao predciitons
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    {
      file_data4 = TFile::Open("/gpfs/mnt/gpfs02/phenix/hhj/hhj1/klsmith/Jpsis/Run15pAu/fit_NOFVTX/krista_fits/tony_bestfit_parameters/sanghoon_corrbg/shao_psi2s_predictions/psi2S_RpAu_MB_predictions_pT.root");
      file_data4->GetObject("RpAu_epps_MB_predictions_bkwd",p2);
      file_data4->GetObject("RpAu_epps_MB_predictions_fwd",p1);
      file_data4->GetObject("RpAu_ncteq_MB_predictions_bkwd",p4);
      file_data4->GetObject("RpAu_ncteq_MB_predictions_fwd",p3);
   ...
   for(int i = 0; i < 18; i++)
    ...
    gr1->GetXaxis()->SetRangeUser(0.1,6);
    ...
    gr1->GetYaxis()->SetRangeUser(0,3.0);
    ...
    gr10->SetMarkerColor(kRed+1);
    gr10->SetLineWidth(3);
    gr10->SetLineColor(kRed+1);
    ...
    // rapp transport
    p5->SetFillStyle(3008);
    p5->SetLineColor(kRed+1);
    p5->SetFillColorAlpha(2,0.5);
    p5->SetLineWidth(0);

    p6->SetFillStyle(3008);
    p6->SetLineColor(kRed+1);
    p6->SetFillColorAlpha(2,0.5);
    p6->SetLineWidth(0);
    ...
    TLegend *leg2 = new TLegend(0.20, 0.57, 0.44, 0.93);  //(start x, start y, end x, end y)
	...
	leg2->AddEntry(p5,"#psi(2S) EPS09+Transport, Du & Rapp", "f");
	leg2->AddEntry(p1,"#psi(2S) EPPS16, Shao et al", "f");
	leg2->AddEntry(p3,"#psi(2S) nCTEQ15, Shao et al", "f");
      }
    else
      {
	...
	leg2->AddEntry(p6,"#psi(2S) EPS09+Transport, Du & Rapp", "f");
	leg2->AddEntry(p2,"#psi(2S) EPPS16, Shao et al", "f");
	leg2->AddEntry(p4,"#psi(2S) nCTEQ15, Shao et al", "f");
      }
    leg2->Draw();
    ...
    if(north_arm)
      c1->SaveAs(Form("../psi2S_pdf/RpAu_psi2s_all_plot_pT_fwd.pdf"));
    else
      c1->SaveAs(Form("../psi2S_pdf/RpAu_psi2s_all_plot_pT_bkwd.pdf"));
}
